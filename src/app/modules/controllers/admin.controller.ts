...
const getPendingReviews = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    try {
...
const moderateReview = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { id } = req.params;
...
const getAdminProfile = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    try {
...
const updateAdminProfile = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    try {
        const authReq = req as AuthenticatedRequest;
